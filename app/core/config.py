...
class Settings(BaseSettings):
    ...
    cta_train_arrivals_url: str = "https://lapi.transitchicago.com/api/1.0/ttarrivals.aspx"
    cta_stations_url: str = "https://data.cityofchicago.org/resource/8mj8-j3c4.json"
